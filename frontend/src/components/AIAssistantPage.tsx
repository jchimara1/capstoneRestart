                ...
                >
                    <Toolbar>
                        ...
                        >
                            ...
                            <Button
                                color="inherit"
                                onClick={() => navigate("/PreviousGoals")}
                            ...
                            <Button
                                ...
                                startIcon={<TipsAndUpdatesTwoToneIcon fontSize="small" />}
                            >
                                AI Assistant
                            </Button>
                        </Box>
                            ...
                            >
                                <Box maxWidth="700px">
                                    ...
                                    <Typography sx={{ fontSize: "1.1rem", lineHeight: 1.8 }}>
                                        I’m really glad you’re here. My job is simple: to help you
                                        feel supported as you set goals and work toward them — one
                                        step at a time.
                                        <br />
                                        Whether you’re feeling motivated, overwhelmed, or somewhere
                                        in between, I’ve got your back.
                                        <br />
                                        You don’t have to figure everything out today. Just tell me
                                        where you’d like to start, and I’ll guide you from there.
                                        <br />
                                        <br />
                                        You can say things like:
                                        <br />• “I want to set a goal.”
                                        <br />• “Help me break this down.”
                                        <br />• “Can you remind me what I’ve already started?”
                                    </Typography>
                                </Box>
